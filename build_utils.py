...
def set_up(env: object, cpp_paths: list[str], sources: list[str], snore_core_addon_dir_name: str, is_setup_for_self = False) -> None:
    if is_setup_for_self:
        ...
        cpp_paths.extend([
            snore_core_addon_dir_name + "/src/",
        ])
        sources.extend(
            glob.glob(snore_core_addon_dir_name + "/src/snore_core/**/*.cpp", recursive=True)
        )
