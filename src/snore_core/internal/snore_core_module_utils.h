...
void register_snore_core_root_module_to_snore_core_main_module(
		const StringName &p_module_name);
void unregister_snore_core_root_module_from_snore_core_main_module(
		const StringName &p_module_name);
...
#define REGISTER_SNORE_CORE_ROOT_MODULE(m_class)                               \
	do {                                                                       \
...
#define UNREGISTER_SNORE_CORE_ROOT_MODULE(m_class)                             \
	do {                                                                       \
		snore_core_module_utils_internal::                                     \
