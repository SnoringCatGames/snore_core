#ifndef TEST_TIME_TIMEOUT_H
#define TEST_TIME_TIMEOUT_H
...
class TimeTimeoutTest : public SnoreCoreTest {
protected:
	void BeforeEach() override { timeout = memnew(TimeTimeout); }
...
TEST_F(TimeTimeoutTest, HasExpiredPlaceholder) {
...
TEST_F(TimeTimeoutTest, Trigger) {
