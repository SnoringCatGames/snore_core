...
void initialize_snore_core_gdextension_types(ModuleInitializationLevel p_level)
{
...
void uninitialize_snore_core_gdextension_types(ModuleInitializationLevel p_level)
{
	if (p_level != MODULE_INITIALIZATION_LEVEL_SCENE)
	{
		return;
...
extern "C"
{
	 ...
	 */
	GDExtensionBool GDE_EXPORT snore_core_extension_init(
		...
		GDExtensionInitialization *r_initialization)
	{
		...
		init_obj.register_initializer(initialize_snore_core_gdextension_types);
		init_obj.register_terminator(uninitialize_snore_core_gdextension_types);
